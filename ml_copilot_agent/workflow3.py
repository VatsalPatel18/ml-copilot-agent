...
class MLWorkflow(Workflow):
    ...
    @step
    async def initialize(self, ctx: Context, ev: StartEvent) -> ML_Copilot_Event:
        ...
        return ML_Copilot_Event(user_input=user_input)

    @step
    async def ml_copilot(self, ctx: Context, ev: ML_Copilot_Event) -> CustomEvent | ListFilesEvent | PreprocessEvent| TrainEvent | EvaluateEvent | PlotEvent | StopEvent :
    ...
    @step
    async def custom_instruction(self, ctx: Context, ev: CustomEvent) -> Union[CustomEvent, ML_Copilot_Event, StopEvent]:
...
"""
    ...
    @step
    async def list_files(self, ctx: Context, ev: ListFilesEvent) -> ML_Copilot_Event :
        files = os.listdir('.')
    ...
    @step
    async def data_preprocessing(self, ctx: Context, ev: PreprocessEvent) -> ML_Copilot_Event :
...
"""
    ...
    @step
    async def training(self, ctx: Context, ev: TrainEvent) -> ML_Copilot_Event :
...
"""
    ...
    @step
    async def evaluation(self, ctx: Context, ev: EvaluateEvent) -> ML_Copilot_Event :
...
"""
    ...
    @step
    async def plotting(self, ctx: Context, ev: PlotEvent) -> ML_Copilot_Event :
    ...
    # @step 
    async def plot_results(self, ctx: Context, ev: PlotEvent) -> ML_Copilot_Event :
    ...
    # @step
    async def plot_data(self, ctx: Context, ev: PlotEvent) -> ML_Copilot_Event :
        # Retrieve the preprocessed data path from the context
        preprocessed_data_path = await ctx.get('preprocessed_data_path', default=None)
