# NOTICE for ML-Copilot-Agent  

This software incorporates components from TabPFN, which is licensed under the **Prior Labs License** (a derivative of Apache 2.0).  
...
### TabPFN License  
TabPFN is licensed under the Prior Labs License. Full terms below:  
...
When distributing or using this software, you must prominently display "Built with TabPFN" on all related websites, UIs, documentation, or publications.  
